...
uplink-security-hardsuit-desc = The standard-issue SLE space proof suit for patrol duty. This bronze variant has cadet rank markings.
...
uplink-security-hardsuit-commmand-desc = A heavily armored SLE suit. Space proof, with thick armor plating at the expense of mobility. This variant has supervisor rank markings.
...
uplink-security-magboots-name = SLE Magboots
...
uplink-security-techfab-name = SLE Techfab
uplink-security-techfab-desc = A circuit board for a SLE Techfab. Allows the production of ammunition, magazines, weapons, and numerous other utilities. Uses raw resources. Can be upgraded.

uplink-security-key-name = SLE Encryption Keys
uplink-security-key-desc = A box of 4 encryption keys that give access to the SLE radio channel.
...
uplink-security-swat-desc = A full-face covering version of the standard issue SLE Gas Mask.
